...
bat2exe
net 相类似也可以利用 iexpress 与 winrar 生成自解压 exe 可执行文件
...
https://www.f2ko.de/downloads/Bat_To_Exe_Converter.zip 将 bat 文件转换为 exe 二进制文件，可以隐藏窗口。
...
https://github.com/mitmproxy/mitmproxy PY,支持 SSL 拦截，进行  流量代理
https://github.com/qiyeboy/BaseProxy py3,异步 http/ 代理,楼上简化版。可以作为中间人工具，比如说替换网址图片等
...
https://github.com/NytroRST/NetRipper 支持截获像 putty,winscp,mssql,chrome,firefox,outlook， 中的明文密码
...
https://www.freebuf.com/ics-articles 工控相关
...
https://m.imooc.com/article/21236 快速自检电脑是否被黑客入侵过(Windows 版)
https://www.freebuf.com/articles/system/157597.html 快速自检电脑是否被黑客入侵过（Linux 版）
...
https://edr.sangfor.com.cn/ win，Linux 下恶意软件、webshell 检测查杀工具
https://www.clamav.net/downloads 病毒查杀软件
https://www.chkrootkit.org/ rootkit 检测工具
https://rootkit.nl/projects/rootkit_hunter.html rootkit 检测工具

## 恶意文件检测之 Webshell 查杀扫描 

https://www.safedog.cn/ 安全狗 web 防火墙
https://d99net.net/ win，啊 D 出品 D 盾 _ 防火墙，包含 waf 与 webshel 检测功能
...
https://github.com/Microsoft/Ethr GO,跨平台,TCP, UDP, HTTP,  压力测试工具
...
https://sc.ftqq.com/3.version server 酱微信通知
...
https://bccto.me 一次性邮箱
https://www.guerrillamail.com 一次性邮箱
https://24mail.chacuo.net/ 一次性邮箱
https://www.yopmail.com 一次性邮箱
